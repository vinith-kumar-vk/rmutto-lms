...
<header class="top-header">
    <div class="header-inner-pill">
        <div class="header-left">
            ...
            <a href="{{ route('category') }}" class="category-select-pill" style="display: flex; align-items: center; gap: 8px;">
                Courses
                <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#3b82f6" stroke-width="3"><polyline points="9 18 15 12 9 6"></polyline></svg>
            </a>
